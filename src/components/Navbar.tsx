    ...
    return (
        <>
            ...
            <nav className=' flex justify-between relative '>
                ...
                <div
                    className={` w-full h-800 flex flex-col  ${!theme ? "bg-teal-300 " : " bg-green-300 "} absolute p-2 overflow-y-auto duration-10 rounded-md ${(!navDivVisiable) ? " right-full rotate-180 scale-50 -z-50  " : "right-0 rotate-0 z-40 scale-100  "} `}
                >
                    <button
